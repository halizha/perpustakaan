        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        @forelse ($siswaKelas12 as $data)
                            <tr>
                                <td><input type="checkbox" wire:model="selectAll" value="{{ $data->id }}"></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Siswa Kelas 12</h5>
