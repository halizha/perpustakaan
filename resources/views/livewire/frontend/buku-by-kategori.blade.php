            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <input type="text" wire:model="search" class="form-control flex-grow-1"
                                ...
                                @foreach ($buku as $item)
                                    <div class="col">
                                        <div class="card h-100 shadow-sm">
                                            {{-- Sampul Buku --}}
                                            @if ($item->sampul)
                                                <img src="{{ asset('storage/' . $item->sampul) }}" class="card-img-top"
                                                    alt="{{ $item->judul }}">
                                            @else
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                ...
                                                <p class="card-text text-muted mb-2">
                                                    <small><i class="bi bi-person"></i> {{ $item->penulis }}</small><br>
                                                    <small><i class="bi bi-building"></i> {{ $item->penerbit }}</small>
                                                </p>
                                                <div class="mt-auto">
